...
func TestNewFuzzyFinder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewFuzzyFinder(tt.args.vaultDir); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewFuzzyFinder() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("FuzzyFinder.listFiles() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("FuzzyFinder.listFiles() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestFuzzyFinder_fuzzySelectFile(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf("FuzzyFinder.fuzzySelectFile() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("FuzzyFinder.fuzzySelectFile() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := f.renderMarkdownPreview(tt.args.i, tt.args.w, tt.args.h); got != tt.want {
				t.Errorf("FuzzyFinder.renderMarkdownPreview() = %v, want %v", got, tt.want)
			}
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if gotTitle != tt.wantTitle {
				t.Errorf("parseFrontMatter() gotTitle = %v, want %v", gotTitle, tt.wantTitle)
			}
			if !reflect.DeepEqual(gotTags, tt.wantTags) {
				t.Errorf("parseFrontMatter() gotTags = %v, want %v", gotTags, tt.wantTags)
			}
		})
	}
}
