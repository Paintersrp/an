	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := note.GetFilepath(); got != tt.want {
				t.Errorf(
					"ZettelkastenNote.GetFilepath() = %v, want %v",
					got,
					tt.want,
				)
			}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf(
					"ZettelkastenNote.EnsurePath() error = %v, wantErr %v",
					err,
					tt.wantErr,
				)
				return
			...
			if got != tt.want {
				t.Errorf(
					"ZettelkastenNote.EnsurePath() = %v, want %v",
					got,
					tt.want,
				)
			}
...
func TestZettelkastenNote_FileExists(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf(
					"ZettelkastenNote.FileExists() error = %v, wantErr %v",
					err,
					tt.wantErr,
				)
				return
			...
			if got != tt.want {
				t.Errorf(
					"ZettelkastenNote.FileExists() got = %v, want %v",
					got,
					tt.want,
				)
			}
			if got1 != tt.want1 {
				t.Errorf(
					"ZettelkastenNote.FileExists() got1 = %v, want %v",
					got1,
					tt.want1,
				)
			}
...
func TestZettelkastenNote_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if (err != nil) != tt.wantErr {
				t.Errorf(
					"ZettelkastenNote.Create() error = %v, wantErr %v",
					err,
					tt.wantErr,
				)
				return
			...
			if got != tt.want {
				t.Errorf(
					"ZettelkastenNote.Create() = %v, want %v",
					got,
					tt.want,
				)
			}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := note.Open(); (err != nil) != tt.wantErr {
				t.Errorf(
					"ZettelkastenNote.Open() error = %v, wantErr %v",
					err,
					tt.wantErr,
				)
			}
...
func TestNewZettelkastenNote(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewZettelkastenNote(tt.args.vaultDir, tt.args.subDir, tt.args.filename, tt.args.tags); !reflect.DeepEqual(
				got,
				tt.want,
			) {
				t.Errorf(
					"NewZettelkastenNote() = %v, want %v",
					got,
					tt.want,
				)
			}
